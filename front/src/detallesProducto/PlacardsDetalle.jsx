          ...
          <div className="producto-card">
            ...
            <div className="colores">
              <span
                ...
                onClick={() => setImg1(Vestidores1)}
              ></span>
              <span
                className="color-circle"
                style={{ background: "#5d4037" }}
                onClick={() => setImg1(Vestidores2)}
              ></span>
            </div>
          ...
          <div className="producto-card">
            ...
            <div className="colores">
              <span
                ...
                onClick={() => setImg2(Vestidores1a)}
              ></span>
              <span
                className="color-circle"
                style={{ background: "#4e342e" }}
                onClick={() => setImg2(Vestidores1b)}
              ></span>
            </div>
          ...
          <div className="producto-card">
            ...
            <div className="colores">
              <span
                ...
                onClick={() => setImg3(Vestidores2a)}
              ></span>
              <span
                className="color-circle"
                style={{ background: "#3e2723" }}
                onClick={() => setImg3(Vestidores2b)}
              ></span>
            </div>
          ...
          <div className="producto-card">
            ...
            <div className="colores">
              <span
                ...
                onClick={() => setImg4(Vestidores3a)}
              ></span>
              <span
                className="color-circle"
                style={{ background: "#6d4c41" }}
                onClick={() => setImg4(Vestidores3b)}
              ></span>
            </div>
